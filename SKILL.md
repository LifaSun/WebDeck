...
Save previews to `.webdeck/slide-previews/` (style-a.html, style-b.html, style-c.html). Each should be self-contained and compact, showing one animated title slide.
...
- Keep the output as a single self-contained WebDeck HTML file.
